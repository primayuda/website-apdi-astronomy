...
const options = {
	keys: ['data.name', 'data.title', 'body'],
	includeMatches: true,
...
function SearchMember({ searchList }) {
	...
	return (
		<div className='grid grid-rows relative'>
			<div className="relative w-80">
                ...
                <Input type="search" placeholder="Cari anggota" className="pl-12 pr-4"onChange={handleOnSearch} />
            </div>
			{query.length > 1 && 
				<div className='absolute top-10 z-50 bg-gray-100 dark:bg-slate-800 rounded-xl p-2'>
				<p className='my-2'>
					Ditemukan {posts.length} anggota terkait '{query}'
				</p>
